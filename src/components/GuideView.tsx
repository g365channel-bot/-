...
export const GuideView: React.FC = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: 'ระบบเชื่อมโยงข้อมูลสุขภาพของพระสงฆ์แต่ละรูปด้วยรหัสประจำตัวพระสงฆ์ (monkId) เดียวกันตลอดชีพ เช่น เมื่อบันทึกผลตรวจสุขภาพในแต่ละปี ระบบจะนำ monkId เดียวกันมาสร้างกราฟเปรียบเทียบและวิเคราะห์แนวโน้มอัตโนมัติ โดยไม่ต้องสร้างรายชื่อพระสงฆ์ใหม่ทุกปี',
    },
    {
    ...
    },
    {
      ...
      a: 'ข้อมูลสุขภาพจัดเป็นข้อมูลส่วนบุคคลที่มีความอ่อนไหวสูง ระบบมีการเข้ารหัสและจำกัดสิทธิ์การเข้าถึงอย่างเคร่งครัดตามมาตรฐานความปลอดภัยบนคลาวด์ Firebase Firestore',
    },
  ];
